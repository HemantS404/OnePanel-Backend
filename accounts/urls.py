...
from .views import RegistrationAPI, SendVerficationAPI, ValidateVerificationView, PasswordResetAPI, PasswordResetView
...
urlpatterns = [
    ...
    path('email-verification/<id>/<token>/', ValidateVerificationView.as_view(), name = 'email-verification'),
